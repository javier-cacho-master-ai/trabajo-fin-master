...
1. A partir de Gaia DR3, obtendremos los mejores cruces de datos con SDSS DR13. 
1. A partir de la lista anterior, filtraremos por aquellos cuerpos que contienen toda la información suficiente para obtener espectros de SDSS.
...
1. De estos datos, crearemos una base de datos con las variables de entrada (coeficientes de Gaia) y objetivo (espectro de SDSS). 


#### Entrenamiento del modelo
El siguiente objetivo constará de la creación de un modelo de aprendizaje automático y su entreno.
