...
![Ejemplo del procedimiento de mejora de datos aplicado a un par de espectros JADES de baja y alta resolución: sobre el espectro original (negro) se generan veinte realizaciones sintéticas (líneas de color) mediante desplazamientos aleatorios del corrimiento al rojo y perturbaciones de flujo (adaptado de @haghjoo2026learning)](_partials/assets/haghjoo2026learning_data_augmentation.png){#fig-jades-mejora-datos}
...
![Distribución de la SNR de los espectros de Gaia y SDSS](_partials/assets/dist_error_abs.png){#fig-SNR-gaia-sdss}
...
![Distribución del error relativo según la longitud de onda de los espectros de Gaia](_partials/assets/dist_error_rel_gaia.png){#fig-error-rel-gaia}
...
![Distribución del error relativo según la longitud de onda de los espectros de SDSS](_partials/assets/dist_err_rel_sdss.png){#fig-error-rel-sdss}
...
![Ejemplo 1 del espectro generado por el modelo de redes neuronales densas con la variable SNR como entrada.](_partials/assets/espectro_predicho_123_full_snr.png){#fig-generado_snr_123}

![Ejemplo 2 del espectro generado por el modelo de redes neuronales densas con la variable SNR como entrada.](_partials/assets/espectro_predicho_191_full_snr.png){#fig-generado_snr_191}
...
: Resultados obtenidos incluyendo la SNR de la muestra de Gaia como entrada del modelo. {#tbl-snr-gaia}
