...
En concreto nos centraremos en el data release número 3 de Gaia y el 13 de Sloan, dado que estos son los que en el DR3 de Gaia ya encontramos semi comparados, o por lo menos las asociaciones de neighborhood hechas [@Gaia_DR3_Documentation_2023].
...
En el desarrollo de un estudio como el que se llevará a cabo en este documento, no solo es importante entender las conclusiones a las que se llega, sino que el contexto que encamina las decisiones tomadas es esencial. No solo es necesario tener una buena base de conocimientos sobre el tema, comprender el proceso de las investigaciones similares que llevaron al punto donde nos ubicamos a día de hoy es importante. 
