...
Para el caso expuesto se considera que las redes neuronales pueden aportar una solución novedosa gracias a su no-linealidad. Será necesario un proceso de prueba y error para encontrar y definir una estructura con buenos resultados. 
...
La base de datos usada para el entrenamiento del modelo debe estar formada por pares de espectros de Gaia y SDSS que correspondan al mismo objeto astronómico. Para garantizar esta correspondencia se debe usar el catálogo de cruce de datos que Gaia incluye en su tercera liberación de datos.
