...
![](_partials/assets/loss_function_evolution.png)

*Fuente: Elaboración propia*

Gráfica de la evolución de la función de pérdida
:::

:::{#fig-mse-evolution}

![](_partials/assets/mse_evolution.png)

*Fuente: Elaboración propia*

Gráfica de la evolución del MSE
:::

:::{#fig-mae-evolution}

![](_partials/assets/mae_evolution.png)
...
![](_partials/assets/espectro_predicho_123_full.png)
...
![](_partials/assets/espectro_predicho_191_full.png)
...
Durante las comparaciones que se harán a continuación, siempre se usarán los mismos objetos, identificados por Gaia con id 2738403223023588608, y por SDSS con 1237657192516026455.
...
![](_partials/assets/espectro_predicho_123_full_mediana_espectro.png)
...
![](_partials/assets/espectro_predicho_191_full_mediana_espectro.png)
...
![](_partials/assets/espectro_predicho_123_full_maximo_espectro.png)
...
![](_partials/assets/espectro_predicho_191_full_maximo_espectro.png)
...
|---|---:|---:|---:|
| Mediana del conjunto de entrenamiento | 0.0086 | 0.0735 | 0.0181 |
...
La última comparación vendrá dada por la librería *ISpec*. <!-- TODO clarisimamente -->
