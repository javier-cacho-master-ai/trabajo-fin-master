...
![](_partials/assets/DiagramaHR.png)
...
En los primeros intentos, las funciones de pérdida, optimizador y parada temprana se mantuvieron igual que las descritas en las redes neuronales densas, dado que habían presentado un buen funcionamiento con estos modelos.
...
En las gráficas detalladas de la @fig-generado_global_10 y la @fig-generado_global_245, se muestran dos ejemplos distintos donde se observan superpuestos los datos de entrada del modelo, es decir el espectro captado por Gaia, el espectro de SDSS real y el generado a partir del modelo entrenado. 
...
Comparándolas con las gráficas obtenidas con la primera normalización mencionada, podemos destacar una diferencia visual pequeá, pero positiva hacia este segundo tipo de normalización. 
...
Al tratar de añadir la [SNR]{.acr} de las muestras de Gaia como parte de los datos de entrada del modelo, los resultados obtenidos sobre los mismos objetos fueron los observados en las gráficas @fig-generado_snr_123 y @fig-generado_snr_191.

:::{#fig-generado_snr_123}

![](_partials/assets/espectro_predicho_123_full_snr.png)
...
:::{#fig-generado_snr_191}

![](_partials/assets/espectro_predicho_191_full_snr.png)
