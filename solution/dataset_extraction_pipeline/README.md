...
├── queries/           consultas ADQL a los TAP de Gaia y SDSS
└── steps/
    ├── __init__.py    registro de pasos (REGISTRY)
    ├── 1_sdss_specobj.py      metadatos del catálogo SDSS SpecObj por placa
    ├── 2_gaia_crossmatch.py   cruce inverso: de los IDs de SDSS a fuentes Gaia
